java -jar RankLib-2.1-patched.jar -load model_bert.txt -rank fce.feature -score fce.score.txt
java -jar RankLib-2.1-patched.jar -load model_bert.txt -rank bea19.feature -score bea19.score.txt
java -jar RankLib-2.1-patched.jar -load model_bert.txt -rank conll14.feature -score conll14.score.txt
java -jar RankLib-2.1-patched.jar -load model_bert.txt -rank jfleg.feature -score jfleg.score.txt
